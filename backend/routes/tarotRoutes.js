...
위 형식을 따라서 이야기해  마지막을 공백 제외 300글자 정도로 작성해줘야해 마지막으로 중요한거 한 카드에 할당되는 position은 하나니 순차적으로 잘 작성해야해. 또한 중요한 건데 endeavor랑 attractiveness랑 love_view는 couple에게 하는게 아니라 하나는 male이고 하나는 female에게 하는 말이야 이거 꼭 기억해해'`,
        },
      ],
    }));
