...
const Love = () => {
  ...
  const fetchReading = async () => {
    try {
      ...
      navigate('/lovedetail', { state: { selectedCards: response.data.cards ,aiResultsTotal: response.data.aiResultsTotal} });
    } catch (error) {
  ...
  const handleRevealClick = () => {
    ...
    if (selectedCards.length === 4) {
      ...
      setTimeout(() => {
        navigate('/lovedetail', { state: { selectedCards} });
  ...
  return (
    ...
    <div id="tarot-screen" className="tarot-purple-love">
      <div className="black-overlay-love">
        <div className="main-title-left-love" onClick={handleTitleClick}>
          <img src={TAROT_logo} alt="TAROT Logo" className="main-title-text-left-love" />
        </div>
        ...
        <div className="container-love">
          ...
          <div className="cards-container-love"></div>

            <button onClick={shuffleCards} className="selection-btn shuffle-btn-love">
              셔플
            </button>
          ...
          <div className="selected-cards-container">
            {selectedCards.map((card, index) => (
              <div key={index} className="selected-card-love">
                <img 
                  src={cardImage} 
